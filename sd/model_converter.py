...
def load_from_standart_weights(input_file: str, device: str) -> dict[str, torch.Tensor]:
    # Keep compatibility with the loader's existing misspelled import path.
    return load_from_standard_weights(input_file, device)
